    ...
    return (
        <div className="flex h-[100dvh] flex-col bg-[#f8f9fa] dark:bg-[#0f1115] overflow-hidden">
            ...
            <div className="flex flex-1 overflow-hidden">
                {/* Cart Sidebar - Left Side (Odoo standard) */}
                <div className="w-[440px] z-20 transition-all bg-white dark:bg-[#18181b] shadow-[4px_0_24px_rgba(0,0,0,0.05)] dark:shadow-[4px_0_24px_rgba(0,0,0,0.2)] border-r border-gray-200 dark:border-gray-800 flex flex-col h-full">
