...
import { G12PrintTemplate } from "./components/g12-print-template"
        ...
        <>
            <div className="space-y-8 print:hidden">
                ...
                <div className="flex flex-wrap gap-4 items-end p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm no-print">
                    ...
                    {result && (
                        <Button variant="outline" onClick={() => window.print()} className="h-10 px-6 rounded-xl gap-2 text-indigo-600 border-indigo-200 hover:bg-indigo-50 dark:text-indigo-400 dark:border-indigo-900 dark:hover:bg-indigo-950/30">
                            <Printer size={16} />
                            Imprimer le formulaire DGI
                        </Button>
                    )}
                </div>
                    ...
                    <div className="g12-result space-y-6">
                        ...
                        <div className="text-center border-b pb-6 border-gray-200 dark:border-gray-700">
                            <h2 className="text-2xl font-black tracking-tight">
                                {mode === "previsionnel" ? "APERÇU G12 — IFU PRÉVISIONNEL" : "APERÇU G12 Bis — IFU DÉFINITIF"}
                            </h2>
            ...
            <div className="hidden print:block absolute top-0 left-0 w-full bg-white text-black min-h-screen z-[9999]">
                {result && <G12PrintTemplate data={result} />}
            </div>
        </>
    )
}
