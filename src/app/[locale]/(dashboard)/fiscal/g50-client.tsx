    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4 items-end p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm no-print">
                ...
                {result && (
                    <Button variant="outline" onClick={handlePrint} className="h-10 px-6 rounded-xl gap-2">
                        <Printer size={16} />
                        Imprimer
                    </Button>
                )}
            ...
            {result && (
                <div className="g50-result space-y-6">
                    ...
                    <div className="text-center border-b pb-6 border-gray-200 dark:border-gray-700">
                        ...
                        <h2 className="text-2xl font-black tracking-tight">DÉCLARATION G50 — TVA</h2>
                        <p className="text-muted-foreground mt-1 capitalize font-medium">{result.period}</p>
                    ...
                    {/* Print footer */}
                    <div className="text-center text-xs text-muted-foreground pt-4 border-t border-dashed border-gray-200 dark:border-gray-700 print-only hidden">
                        <p>Document généré automatiquement par SYNCLOUDPOS — À vérifier avec votre comptable</p>
                        <p className="mt-1">Imprimé le {new Date().toLocaleDateString("fr-DZ", { dateStyle: "long" })}</p>
                    </div>
                </div>
            )}
