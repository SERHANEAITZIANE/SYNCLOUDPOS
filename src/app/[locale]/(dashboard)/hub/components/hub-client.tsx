...
export const HubClient: React.FC = () => {
    ...
    const allQuickActions: QuickAction[] = useMemo(() => [
        ...
        { label: "Catalogue de Vente",     href: "/catalog",             icon: BookOpen,       color: "#f59e0b", colorEnd: "#d97706", shadowColor: "rgba(245,158,11,0.35)" },
        { label: "Produits",               href: "/products",            icon: Package,        color: "#10b981", colorEnd: "#059669", shadowColor: "rgba(16,185,129,0.35)" },
        { label: "Contrôle du Stock",      href: "/products/stock",      icon: ClipboardList,  color: "#14b8a6", colorEnd: "#0d9488", shadowColor: "rgba(20,184,166,0.35)" },
        ...
        { label: "Factures Récurrentes",   href: "/recurring-invoices",  icon: Repeat,         color: "#0ea5e9", colorEnd: "#0284c7", shadowColor: "rgba(14,165,233,0.35)" },
        { label: "Emprunts Client",        href: "/emprunt",             icon: Landmark,       color: "#f43f5e", colorEnd: "#e11d48", shadowColor: "rgba(244,63,94,0.35)" },
        { label: "Dettes Fournisseur",     href: "/emprunt-fournisseur", icon: Building2,      color: "#ea580c", colorEnd: "#c2410c", shadowColor: "rgba(234,88,12,0.35)" },
        { label: "Trésorerie",             href: "/treasury",            icon: Wallet,         color: "#06b6d4", colorEnd: "#0891b2", shadowColor: "rgba(6,182,212,0.35)" },
        { label: "Chèques",                href: "/treasury/cheques",     icon: Receipt,        color: "#10b981", colorEnd: "#059669", shadowColor: "rgba(16,185,129,0.35)" },
        { label: "Rapprochement",          href: "/treasury/reconciliation", icon: RefreshCw,    color: "#3b82f6", colorEnd: "#2563eb", shadowColor: "rgba(59,130,246,0.35)" },
        { label: "Clôture de Caisse",      href: "/cloture",             icon: LockKeyhole,    color: "#ea580c", colorEnd: "#c2410c", shadowColor: "rgba(234,88,12,0.35)" },
        ...
        { label: "Marques",                href: "/brands",              icon: Tag,            color: "#8b5cf6", colorEnd: "#7c3aed", shadowColor: "rgba(139,92,246,0.35)" },
        { label: "Promotions",             href: "/promotions",          icon: Gift,           color: "#f43f5e", colorEnd: "#e11d48", shadowColor: "rgba(244,63,94,0.35)" },
        { label: "Avaries",                href: "/avaries",             icon: Package,        color: "#ea580c", colorEnd: "#c2410c", shadowColor: "rgba(234,88,12,0.35)" },
        { label: "Transferts Inter-Dépôts",href: "/transfers",           icon: ArrowRightLeft, color: "#14b8a6", colorEnd: "#0d9488", shadowColor: "rgba(20,184,166,0.35)" },
        { label: "Impression Codes-barres",href: "/barcode-labels",      icon: Tag,            color: "#6366f1", colorEnd: "#4f46e5", shadowColor: "rgba(99,102,241,0.35)" },
        { label: "Réservations Clients",   href: "/reservations",        icon: Package2,       color: "#ec4899", colorEnd: "#db2777", shadowColor: "rgba(236,72,153,0.35)" },
        { label: "Livraisons & Expéditions",href: "/delivery",           icon: MapPin,         color: "#14b8a6", colorEnd: "#0d9488", shadowColor: "rgba(20,184,166,0.35)" },
        { label: "Suivi Livreur GPS",      href: "/driver-tracking",     icon: MapPin,         color: "#22c55e", colorEnd: "#16a34a", shadowColor: "rgba(34,197,94,0.35)" },
        { label: "Portail Livreur",        href: "/driver",              icon: Truck,          color: "#f59e0b", colorEnd: "#d97706", shadowColor: "rgba(245,158,11,0.35)" },
        { label: "Réapprovisionnements",  href: "/reorder",             icon: RefreshCw,      color: "#06b6d4", colorEnd: "#0891b2", shadowColor: "rgba(6,182,212,0.35)" },
        { label: "Audits d'Inventaires",  href: "/inventory-audit",     icon: ClipboardList,  color: "#a855f7", colorEnd: "#9333ea", shadowColor: "rgba(168,85,247,0.35)" },
        { label: "Inventaire Annuel",     href: "/inventaire-annuel",    icon: Package,        color: "#14b8a6", colorEnd: "#0d9488", shadowColor: "rgba(20,184,166,0.35)" },
        { label: "Commissions Vendeurs",   href: "/commissions",         icon: Award,          color: "#ec4899", colorEnd: "#db2777", shadowColor: "rgba(236,72,153,0.35)" },
        { label: "Rapports d'Activité",   href: "/reports",             icon: BarChart3,      color: "#ef4444", colorEnd: "#dc2626", shadowColor: "rgba(239,68,68,0.35)" },
        { label: "Analytiques Graphiques", href: "/analytics",           icon: LineChart,      color: "#6366f1", colorEnd: "#4f46e5", shadowColor: "rgba(99,102,241,0.35)" },
        { label: "Marge & Rentabilité",    href: "/reports/profit",      icon: TrendingUp,     color: "#22c55e", colorEnd: "#16a34a", shadowColor: "rgba(34,197,94,0.35)" },
        { label: "Impôts G50 / IFU",       href: "/fiscal",              icon: Receipt,        color: "#f59e0b", colorEnd: "#d97706", shadowColor: "rgba(245,158,11,0.35)" },
        { label: "Journaux Comptables",    href: "/journals",            icon: BookOpen,       color: "#0ea5e9", colorEnd: "#0284c7", shadowColor: "rgba(14,165,233,0.35)" },
        { label: "Dashboard Classique",    href: "/dashboard",           icon: LayoutDashboard,color: "#3b82f6", colorEnd: "#2563eb", shadowColor: "rgba(59,130,246,0.35)" },
        { label: "Assistant IA",           href: "/ai",                  icon: Sparkles,       color: "#6366f1", colorEnd: "#4f46e5", shadowColor: "rgba(99,102,241,0.35)" },
        { label: "Mon Entreprise",         href: "/company",             icon: Store,          color: "#ea580c", colorEnd: "#c2410c", shadowColor: "rgba(234,88,12,0.35)" },
        { label: "Gestion Utilisateurs",   href: "/users",               icon: Users,          color: "#8b5cf6", colorEnd: "#7c3aed", shadowColor: "rgba(139,92,246,0.35)" },
        { label: "Paramètres Systèmes",    href: "/settings",            icon: Settings,       color: "#64748b", colorEnd: "#475569", shadowColor: "rgba(100,116,139,0.35)" },
        { label: "Journaux d'Audit",       href: "/audit-log",           icon: History,        color: "#a855f7", colorEnd: "#9333ea", shadowColor: "rgba(168,85,247,0.35)" },
        { label: "Formation ERP",          href: "/formation",           icon: BookOpen,       color: "#06b6d4", colorEnd: "#0891b2", shadowColor: "rgba(6,182,212,0.35)" },
    ], []);

    const DEFAULT_QUICK_HREFS = useMemo(() => [
        "/pos", "/products", "/products/stock", "/purchases", "/sales",
        "/payments", "/retours", "/emprunt", "/treasury", "/expenses",
        "/customers", "/suppliers", "/reports", "/dashboard", "/settings"
    ], []);
