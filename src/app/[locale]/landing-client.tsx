          ...
          <div className="lp-apps-grid">
            ...
            <div className="lp-app-card lp-reveal">
              ...
              <div className="lp-app-download-zone">
                ...
                <a
                  href="https://chirpedbeo.online/downloads/syncloudpos-gerant-v2.2.0.apk"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="lp-download-link"
                >
                  chirpedbeo.online/downloads/syncloudpos-gerant-v2.2.0.apk
                </a>
                ...
                <div className="lp-qr-container">
                  <div className="lp-qr-box">
                    <QRCodeSVG
                      value="https://chirpedbeo.online/downloads/syncloudpos-gerant-v2.2.0.apk"
                      size={80}
                      level="H"
                      includeMargin={false}
                    />
