...
export const FALLBACK_MODELS: Record<AIProvider, string[]> = {
    GEMINI: ["gemini-2.5-flash", "gemini-3.5-flash", "gemini-2.5-pro", "gemini-3-flash-preview", "gemini-2.0-flash"],
...
export const AVAILABLE_MODELS: Record<AIProvider, { id: string; label: string }[]> = {
    GEMINI: [
        { id: "gemini-2.5-flash", label: "Gemini 2.5 Flash (Stable — Recommandé)" },
