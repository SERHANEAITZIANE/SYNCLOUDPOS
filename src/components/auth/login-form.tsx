        ...
        <div className="w-full">
            ...
            <div className="mb-8">
                ...
                <p className="text-sm" style={{ color: "#6b7280" }}>
                    Connectez-vous à votre espace de vente
                </p>
            </div>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link href="/auth/reset" className="text-xs hover:text-purple-400 transition-colors" style={{ color: "#7c3aed" }}>
                                        Mot de passe oublié ?
                                    </Link>
                                </div>
                                <FormControl>
                    ...
                    {error && (
                        <div className="flex items-start gap-3 p-3 rounded-xl" style={{ background: "rgba(239,68,68,0.1)", border: "1px solid rgba(239,68,68,0.2)" }}>
            ...
            <p className="text-center text-sm mt-6" style={{ color: "#6b7280" }}>
                {t("footer.noAccount")}{" "}
                <Link href="/register" className="font-medium hover:text-purple-300 transition-colors" style={{ color: "#a78bfa" }}>
