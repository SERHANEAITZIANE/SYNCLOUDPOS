...
const TODAY_DATA: DailyCloseData = {
    ...
    transactions: [
        { label: "Ventes du jour (BLs)", amount: 185000, type: "in" },
        { label: "Encaissements clients", amount: 35000, type: "in" },
        { label: "Retours marchandise", amount: -12500, type: "out" },
        { label: "Dépenses & décaissements", amount: -42000, type: "out" },
    ],
};
...
export default function DailyCloseScreen() {
    const [data] = useState(TODAY_DATA);
    ...
    const discrepancy = countedCash - data.expectedCash;
            ...
            <View style={styles.closedContainer}>
                <View style={styles.closedCard}>
                    ...
                    <View style={styles.closedStamp}>
                        ...
                        <Text style={styles.closedStampText}>Archivé à {new Date().toLocaleTimeString("fr-FR", { hour: "2-digit", minute: "2-digit" })}</Text>
                    </View>
                </View>
            </View>
        );
...
const styles = StyleSheet.create({
    ...
    denomBadge: {
        width: 80, backgroundColor: "#0f172a", borderRadius: 8,
        paddingVertical: 6, paddingHorizontal: 8, borderWidth: 1, borderColor: "#334155",
    },
    denomText: { color: "#f8fafc", fontSize: 12, fontWeight: "700", textAlign: "center" },
    denomX: { color: "#64748b", fontSize: 14, fontWeight: "700" },
    denomInput: {
        width: 52, height: 36, backgroundColor: "#0f172a", borderRadius: 8,
        color: "#f8fafc", textAlign: "center", fontSize: 14, fontWeight: "700",
    ...
    countTotal: {
        flexDirection: "row", justifyContent: "space-between", alignItems: "center",
        backgroundColor: "#0f172a", borderRadius: 10, padding: 12, marginTop: 8,
    ...
    notesInput: {
        backgroundColor: "#0f172a", borderRadius: 10, minHeight: 60,
        color: "#f8fafc", padding: 12, borderWidth: 1, borderColor: "#334155",
    ...
    closeBtn: {
        ...
        gap: 8, marginHorizontal: 16, marginTop: 20, height: 52,
    ...
    closedSummary: {
        width: "100%", backgroundColor: "#0f172a", borderRadius: 14,
        padding: 16, marginTop: 20, gap: 10,
    },
    closedRow: {
        flexDirection: "row", justifyContent: "space-between",
        paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: "#334155",
    },
    closedLabel: { color: "#94a3b8", fontSize: 13, fontWeight: "600" },
    closedValue: { color: "#f8fafc", fontSize: 14, fontWeight: "800" },
    closedStamp: {
        flexDirection: "row", alignItems: "center", gap: 6, marginTop: 16,
        backgroundColor: "#22c55e15", paddingHorizontal: 12, paddingVertical: 6,
